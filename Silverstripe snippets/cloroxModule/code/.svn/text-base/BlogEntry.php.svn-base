...
class BlogEntry extends Page {
	...
	static $has_one = array('Image1'=>'Image','Image2'=>'Image','Image3'=>'Image','Image4'=>'Image','Image5'=>'Image');
	...
	function getCMSFields() {
       ...
       $fields->addFieldToTab("Root.Main", new HtmlEditorField("Content", _t("BlogEntry.CN", "Content"), 70));
		...
		$fields->addFieldToTab("Root.Main", new HtmlEditorField("Excerpt", _t("BlogEntry.EX", "Excerpt")));
