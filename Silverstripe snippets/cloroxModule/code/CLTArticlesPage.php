 ...
 * @version $Id
 */
class CLTArticlesPage extends Page {
    ...
    public function GetAllArticles(){
        $allArticles = CLTPanel::get()->filter(array('Panel_Class'=>'Article'));
        return $allArticles;
    }
	...
	public function getArticlesByMonth($month){
		return $this -> getManyManyComponents('Articles') -> filter('created');
	}
    public function Tips() {
        return $this -> getManyManyComponents('Tips') -> sort('SortOrderTips');
    }
...
class CLTArticlesPage_Controller extends Page_Controller {
